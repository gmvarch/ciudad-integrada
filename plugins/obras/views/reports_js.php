...
?>
	 ...
	 */
	 function switchViews(view)
	 {
		...
		$("#reports-list .report-list-toggle a").parent().removeClass("active");
	...
	{
		$("#reports-list .report-list-toggle a").click(function(){
			...
			function(data) {
				if (data != null && data != "" && data.length > 0) {
					...
					setTimeout(function(){
						...
						{
							switchViews($("#reports-list .report-list-toggle a.map"));
						}
